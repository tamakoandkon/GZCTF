...
import api, { AnswerResult, ExerciseSubmission } from '@Api'
...
const Submissions: FC = () => {
  ...
  const newSubmissions = useRef<ExerciseSubmission[]>([])
  ...
  useEffect(() => {
    const fetchSubmissions = async () => {
      try {
        const res = await api.exercise.exerciseSubmissions({
        ...
        showNotification({
          color: 'red',
          title: t('exercise.notification.fetch_failed.submission'),
  ...
  useEffect(() => {
    ...
    connection.on('ReceivedExerciseSubmission', (message: ExerciseSubmission) => {
    ...
    const startConnection = async () => {
      try {
        ...
        showNotification({
          color: 'teal',
          message: t('exercise.notification.connected.submission'),
  ...
  return (
    <WithExerciseMonitor isLoading={!submissions}>
