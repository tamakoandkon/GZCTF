...
namespace GZCTF.Migrations
{
    ...
    [Migration("20260813122758_AddExerciseMonitoring")]
    partial class AddExerciseMonitoring
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GZCTF.Models.Data.ExerciseCheatInfo", b =>
                {
                    b.Property<int>("ExerciseSubmissionId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("ExerciseSubmissionId");

                    b.HasIndex("ExerciseId");

                    b.HasIndex("ExerciseSubmissionId")
                        .IsUnique();
                    ...
                    b.ToTable("ExerciseCheatInfo");
                });

            modelBuilder.Entity("GZCTF.Models.Data.ExerciseEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.ExerciseSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.FlagContext", b =>
                {
                    ...
                    b.Property<int?>("PoolChallengeId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GZCTF.Models.Data.PoolChallenge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("RangeEnabled")
                        .HasColumnType("boolean");

                    b.Property<int>("RangeScore")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RangeEnabled");

                    b.HasIndex("TestContainerId");

                    b.ToTable("PoolChallenges");
                });
            ...
            modelBuilder.Entity("GZCTF.Models.Data.ExerciseCheatInfo", b =>
                {
                    b.HasOne("GZCTF.Models.Data.PoolChallenge", "Exercise")
                        .WithMany()
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GZCTF.Models.Data.ExerciseSubmission", "Submission")
                        .WithMany()
                        .HasForeignKey("ExerciseSubmissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GZCTF.Models.Data.UserInfo", "SourceUser")
                        .WithMany()
                        .HasForeignKey("SourceUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GZCTF.Models.Data.UserInfo", "SubmitUser")
                        .WithMany()
            ...
            modelBuilder.Entity("GZCTF.Models.Data.FlagContext", b =>
                {
                    ...
                    b.HasOne("GZCTF.Models.Data.PoolChallenge", "PoolChallenge")
                        .WithMany("Flags")
                        .HasForeignKey("PoolChallengeId");

                    b.Navigation("Attachment");

                    b.Navigation("Challenge");

                    b.Navigation("PoolChallenge");
                });
